...
function statusColor(status: string) {
  switch (status) {
    ...
    case "Completed": return "bg-[#c8e056]/15 text-[#6b7a1e] border-[#c8e056]/30";
    case "Not Started": return "bg-gray-50 text-gray-600 border-gray-200";
    case "In Progress": return "bg-[#ff6a2c]/10 text-[#ff6a2c] border-[#ff6a2c]/20";
...
function ratingDisplay(rating: number | null) {
  ...
  const color = rating >= 4.5 ? "#22c55e" : rating >= 3.5 ? "#ff6a2c" : rating >= 2.5 ? "#f59e0b" : "#ef4444";
    ...
    <motion.div variants={stagger} initial="hidden" animate="show" className="space-y-6">
      ...
      <motion.div variants={fadeUp}>
        <div className="flex items-center justify-between mb-4">
          ...
          <Badge className="rounded-full bg-[#ff6a2c]/10 text-[#ff6a2c] hover:bg-[#ff6a2c]/15 text-xs">
            ...
            <motion.div key={okr.id} variants={fadeUp}>
              <Card className="border-[var(--saptta-line)] rounded-[20px] overflow-hidden">
                <CardContent className="p-0">
                  ...
                  >
                    <div className="mt-0.5 flex size-8 items-center justify-center rounded-[12px] bg-[#ff6a2c]/10 shrink-0">
                      <Target className="size-4 text-[#ff6a2c]" />
                    </div>
                              ...
                              <div className="space-y-2">
                                {okr.departmentOKRs.map((dokr) => (
                                  <div key={dokr.id} className="rounded-xl border border-[var(--saptta-line)] px-3 py-2.5 flex items-center gap-3">
                                    <div className="flex size-6 items-center justify-center rounded-[10px] bg-[#c8e056]/15 shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <Dialog open={createGoalOpen} onOpenChange={setCreateGoalOpen}>
              <DialogTrigger asChild>
                <Button size="sm" className="rounded-full bg-[#ff6a2c] text-white text-xs hover:bg-[#ff6a2c]/90 h-8">
              ...
              <DialogContent className="rounded-[24px] sm:max-w-md">
                ...
                <DialogFooter>
                  ...
                  <Button className="rounded-full bg-[#ff6a2c] text-white hover:bg-[#ff6a2c]/90" onClick={() => setCreateGoalOpen(false)}>
                    Create Goal
                  </Button>
                </DialogFooter>
              </DialogContent>
          ...
          {filteredGoals.map((goal) => (
            ...
            >
              <Avatar className="size-8 shrink-0">
                <AvatarFallback className="bg-[#ff6a2c]/10 text-[#ff6a2c] text-[10px] font-semibold">
          ...
          {selectedGoal && (
            <>
              ...
              <DialogFooter>
                ...
                <Button className="rounded-full bg-[#ff6a2c] text-white hover:bg-[#ff6a2c]/90">Edit Goal</Button>
              </DialogFooter>
            </>
          )}
        </DialogContent>
        ...
        <Card className="border-[var(--saptta-line)] rounded-[24px] overflow-hidden">
          <CardContent className="p-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <div className="flex items-center gap-2">
                  <div className="flex size-10 items-center justify-center rounded-[16px] bg-[#ff6a2c]/10">
                    <Gauge className="size-5 text-[#ff6a2c]" />
                  </div>
                  <div>
                ...
                <div className="mt-4 flex items-center gap-3">
                  <div className="flex-1 max-w-xs h-3 rounded-full bg-[var(--saptta-bg-2)] overflow-hidden">
                    <motion.div
                      className="h-full rounded-full bg-[#ff6a2c]"
                      initial={{ width: 0 }}
                      animate={{ width: `${cycleProgress}%` }}
                      transition={{ duration: 1, ease: [0.22, 0.8, 0.22, 1] }}
                    />
                  </div>
                  <span className="text-sm font-bold text-[#ff6a2c]">{cycleProgress}% completed</span>
                </div>
              ...
              <Dialog open={newCycleOpen} onOpenChange={setNewCycleOpen}>
                <DialogTrigger asChild>
                  <Button size="sm" className="rounded-full bg-[#ff6a2c] text-white text-xs hover:bg-[#ff6a2c]/90 h-8 shrink-0">
                ...
                <DialogContent className="rounded-[24px] sm:max-w-md">
                  ...
                  <DialogFooter>
                    ...
                    <Button className="rounded-full bg-[#ff6a2c] text-white hover:bg-[#ff6a2c]/90" onClick={() => setNewCycleOpen(false)}>
                      Create Cycle
                    </Button>
                  </DialogFooter>
                </DialogContent>
                  ...
                  <React.Fragment key={step.label}>
                    <div className="flex flex-col items-center min-w-[80px]">
                      <div
                        className={`flex size-10 items-center justify-center rounded-full transition-all ${
                          isCompleted
                            ...
                            : isCurrent
                            ? "bg-[#ff6a2c] text-white ring-4 ring-[#ff6a2c]/20"
                      ...
                      <p className={`text-[10px] mt-1.5 font-medium text-center ${
                        isCompleted ? "text-[#22c55e]" : isCurrent ? "text-[#ff6a2c]" : "text-[var(--saptta-mute)]"
                      }`}>
                        {step.label}
                      </p>
                      {isCurrent && (
                        <span className="text-[8px] text-[#ff6a2c] font-semibold mt-0.5">IN PROGRESS</span>
                      )}
                    </div>
                      ...
                      <TableCell className="pl-6">
                        <div className="flex items-center gap-2">
                          <Avatar className="size-7">
                            <AvatarFallback className="bg-[#ff6a2c]/10 text-[#ff6a2c] text-[9px] font-semibold">
                              {emp.initials}
                            </AvatarFallback>
                          </Avatar>
    ...
    <motion.div variants={stagger} initial="hidden" animate="show" className="space-y-6">
      ...
      <motion.div variants={fadeUp} className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <Card className="border-[var(--saptta-line)] rounded-[16px]">
          <CardContent className="p-3 text-center">
            <p className="text-lg font-bold text-[#ff6a2c]">{pendingCount}</p>
        ...
        <Card className="border-[var(--saptta-line)] rounded-[16px]">
          <CardContent className="p-3 text-center">
            <p className="text-lg font-bold text-[#c8e056]">
      ...
      <motion.div variants={fadeUp}>
        <div className="flex items-center gap-2 p-1 bg-[var(--saptta-bg-2)] rounded-full w-fit">
          ...
          >
            Requests {pendingCount > 0 && <span className="ml-1 inline-flex items-center justify-center size-4 rounded-full bg-[#ff6a2c] text-white text-[9px]">{pendingCount}</span>}
          </button>
          <button
            className={`px-4 py-1.5 rounded-full text-xs font-medium transition-all ${
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start gap-3">
                      <Avatar className="size-9 shrink-0">
                        <AvatarFallback className="bg-[#c8e056]/20 text-[#6b7a1e] text-[10px] font-semibold">
                          {req.targetInitials}
                        </AvatarFallback>
                      </Avatar>
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-2 flex items-center gap-3">
                          ...
                          {req.status === "Pending" && (
                            <Button
                              size="sm"
                              className="rounded-full bg-[#ff6a2c] text-white text-[10px] h-6 hover:bg-[#ff6a2c]/90"
                              onClick={(e) => {
                                e.stopPropagation();
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <div className="flex items-center gap-1 bg-[#c8e056]/15 rounded-full px-2 py-0.5">
          ...
          {selectedFeedback && (
            <>
              ...
              <DialogFooter>
                ...
                <Button
                  className="rounded-full bg-[#ff6a2c] text-white hover:bg-[#ff6a2c]/90"
...
function NineBoxTab() {
  ...
  function getCellColor(perf: string, pot: string) {
    ...
    if (perf === "Medium" && pot === "High") return { bg: "#c8e056", bgLight: "#c8e05615", text: "#3d4f0d", label: "High Potentials" };
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <div className="space-y-2">
                ...
                {[
                  { color: "#c8e056", label: "High Potentials", desc: "Medium performance, high potential" },
...
export function PerformanceView() {
  ...
  return (
    <motion.div variants={stagger} initial="hidden" animate="show" className="space-y-6">
      ...
      {/* Stats Row */}
      <motion.div variants={fadeUp} className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <StatCard icon={Target} value="5" label="Company OKRs" color="#ff6a2c" />
        <StatCard icon={Award} value="72%" label="Review Completion" color="#c8e056" />
      ...
      <motion.div variants={fadeUp}>
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="bg-[var(--saptta-bg-2)] rounded-full p-1 h-auto gap-0">
            <TabsTrigger
              value="goals"
              className="rounded-full text-xs data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-[#ff6a2c] px-4 py-1.5"
            >
            ...
            <TabsTrigger
              value="feedback"
              className="rounded-full text-xs data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-[#ff6a2c] px-4 py-1.5 relative"
            >
              <MessageSquare className="size-3.5 mr-1.5" /> 360 Feedback
              {pendingFeedback > 0 && (
                <span className="ml-1 inline-flex items-center justify-center size-4 rounded-full bg-[#ff6a2c] text-white text-[8px] font-bold">
                  {pendingFeedback}
                </span>
              )}
            </TabsTrigger>
