...
const initialMessages: ChatMessage[] = [
  {
    role: "assistant",
    content: "Hello, Priya! 👋 I'm Kam AI, your HR assistant. I can help you with employee data, attendance insights, payroll queries, recruitment analytics, and more. What would you like to know?",
    category: undefined,
    sources: [],
  ...
  return (
    <motion.div variants={stagger} initial="hidden" animate="show" className="space-y-6">
      <motion.div variants={fadeUp}>
        ...
        <p className="text-[var(--saptta-mute)] mt-1 text-sm">Ask Kam AI anything about your HR data, policies, and analytics. <span className="text-green-600 text-xs font-medium">100% Local — No API Key Required</span></p>
      </motion.div>
              ...
              <div className="border-t border-[var(--saptta-line)] p-4">
                <form onSubmit={(e) => { e.preventDefault(); handleSend(); }} className="flex items-center gap-2">
                  <input
                    ...
                    placeholder="Ask Kam AI anything..."
