  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[{label:"Total Gross",value:formatCurrency(payrollSummary.totalGross),icon:<IndianRupee className="w-5 h-5" />,color:"#FF9900",trend:"+1.7%",trendUp:true},{label:"Total Net",value:formatCurrency(payrollSummary.totalNet),icon:<Wallet className="w-5 h-5" />,color:"#10b981",trend:"+2.1%",trendUp:true},{label:"Total Deductions",value:formatCurrency(payrollSummary.totalDeductions),icon:<TrendingDown className="w-5 h-5" />,color:"#f59e0b",trend:"+0.5%",trendUp:false},{label:"Employees Processed",value:`${payrollSummary.employeesProcessed}/${payrollSummary.totalEmployees}`,icon:<Users className="w-5 h-5" />,color:"#8b5cf6",trend:"97.4%",trendUp:true}].map((card,i)=>(
